...
public class ProductManageController {
    ...
    public ServerResponse productSave(HttpSession session, Product product){
        ...
        if (iUserService.checkAdminRole(user).isSuccess()){
            ...
            return ServerResponse.createByErrorMessage("not a admin");
        }
    }
    ...
    public ServerResponse upload(HttpSession session,
        ...
        //this directory will be in webapp/
    ...
    public Map richtextImageUpload(HttpSession session,
        ...
        //the return value  of richtext has it's own type,we use simditor,so return as simditor required.
//        see https://simditor.tower.im/docs/doc-config.html
//        {
//            "success": true/false,
...
//        }
        ...
        //对后端的httpServerletResponse的返回值有要求。
        //要修改http header的 Access-Control-Allow-Headers 字段
        response.addHeader("Access-Control-Allow-Headers","X-File-Name");//和前端的约定
